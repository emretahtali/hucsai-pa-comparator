...
def header_watermark(root, hover_theme):
    ...
    # image = ct.CTkImage(light_image=Image.open("github-logo.png"), dark_image=Image.open("github-logo.png"))
    button = ct.CTkButton(master=header, text="github", fg_color=ct.ThemeManager.theme["CTkLabel"]["fg_color"], width=0,
